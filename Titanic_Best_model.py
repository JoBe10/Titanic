...
# Instead, drop the missing values from Age
# train.dropna(subset=['Age'], inplace=True)

# Inspect differences in survival chances by age and gender

# Create varibales for men
...
# Group decks into either in B to F or not
...
# Remove all titles but the fisrt four (Mr, Mrs, Miss, Master)
...
# Print feature importances and score
